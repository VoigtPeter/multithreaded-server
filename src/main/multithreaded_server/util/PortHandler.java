...
public class PortHandler {
	...
	/**
	 * This method marks a port as "reserved" so the port handler won't return it
	 * when a program requests a port from the port range
	 * 
	 * @param port
	 *            Port
	 */
	...
	/**
	 * This method marks a reserved port as "free" NOTE: Use for reserved ports only
	 * 
	 * @param port
	 *            Port
	 */
	...
	/**
	 * This method marks every reserved port as "free" NOTE: Use for reserved ports
	 * only
	 */
	...
	/**
	 * This method returns a free port within the set range If the whitelist is
	 * enabled it will only return free ports from the whitelist As long as the
	 * whitelist is enabled the blacklist is automatically disabled
	 * 
	 * @return A free Port
	 */
